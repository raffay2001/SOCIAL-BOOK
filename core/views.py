...
def index(request):
    ...
    return render(request, 'index.html', {'user_profile': user_profile_object, 'posts': feed_list, 'suggestions_username_profile_list': suggestions_username_profile_list[:4]})
